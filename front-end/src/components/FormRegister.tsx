    ...
    return (
        <>
            ...
            <form className="flex flex-col [&>input]:bg-[#f5f1f1] [&>label]:text-[23px] [&>input]:rounded-md [&>input]:p-3 [&>input]:text-2xl [&>input]:w-full gap-2 w-120 [&>input]:outline-none" action="">
                ...
                <button className="bg-[#544f4b] cursor-pointer text-white py-3 w-full rounded-[20px] tracking-[2px] text-[26px] hover:bg-[#2c2927] duration-300" type="submit">CADASTRO</button>
            </form>
        </>
    )
}
